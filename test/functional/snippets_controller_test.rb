...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { description: @snippet.description, permalink: @snippet.permalink, snippet_type: @snippet.snippet_type }
    end
  ...
  test "should update snippet" do
    put :update, id: @snippet, snippet: { description: @snippet.description, permalink: @snippet.permalink, snippet_type: @snippet.snippet_type }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
